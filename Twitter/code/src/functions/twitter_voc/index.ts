...
export const run = async (events: any[]) => {
  for (const event of events) {
    ...
    const llmUtil: LLMUtils = new LLMUtils(fireWorksApiKey, `accounts/fireworks/models/${inputs['llm_model_to_use']}`, 14200);
    let numReviews = 10;
